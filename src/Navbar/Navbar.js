        ...
        <nav className="navbar navbar-expand-md navbar-dark">
          <div className="container-fluid">
            <a href="" className="navbar-brand">
              <img src="https://firstfiddle.in/_next/image?url=%2Fimages%2Fheader%2Flogo-01.png&w=256&q=75" width="40px" height="50px" alt="33" className="until img-fluid">
              </img>
            </a>
            ...
            <div className="collapse navbar-collapse" id="pn">
              <ul className="navbar-nav ms-auto">
                ...
                <li><a href="" className="nav-link text-white">OUR STORY</a></li>
                ...
                <li><a href="" className="nav-link text-white">FRANCHISE</a></li>
