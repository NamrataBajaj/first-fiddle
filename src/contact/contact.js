            ...
            <div className="container">
                <div className="row">
                    ...
                    <div className="col-md-6">
                        <img src="https://www.firstfiddle.in/_next/image?url=%2Fimages%2Fabout%2FAbout1.jpg&w=640&q=75" alt="" className="img-fluid pt-5"></img>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section className="bg-black text-white pt-5">
                ...
                <div className="container">
                    <div className="row">
                        ...
                        <div className="col-md-2">
                            ...
                            <ul>
                            <li className="item">Jaipur</li>
                                 <li className="item"> Delhi</li>
                                 <li className="item">Indore</li>
                            </ul>
                            <h5 className="text-warning">FLYING SAUCER</h5>
                            <ul>
                                 <li className="item">Bhopal</li>
                                 <li className="item">Jhansi</li>
                            </ul>
                            <h5 className="text-warning">TICKLED PINK</h5>
                            <ul>
                                 <li className="item">Delhi</li>
                                 <li className="item"> Lucknow</li>
                            </ul>
                            <h5 className="text-warning">JLWA</h5>
                            <ul>
                                 <li className="item">kanpur</li>
                            </ul>
                        </div>
                        <div className="col-md-2">
                            <h5 className="pt-3 text-warning">LOTD</h5>
                            <ul>
                                 <li className="item"> Noida</li>
                                 <li className="item"> Delhi</li>
                                 <li className="item"> Hyderabad</li>
                                 <li className="item"> Chennai</li>
                                 <li className="item"> Bangalore</li>
                                 <li className="item"> Mumbai</li>
                                 <li className="item"> Kolkata</li>
                                 <li className="item"> Lucknow</li>
                                 <li className="item"> Agra</li>
                                 <li className="item"> Nagpur</li>
                                 <li className="item"> Ranchi</li>
                                 <li className="item"> Jim Corbette</li>
                                 <li className="item"> Lucknow</li>
                            </ul>
                        </div>
                        <div className="col-md-2">
                            <h5 className="pt-3 text-warning">WAREHOUSE</h5>
                            <ul>
                                 <li className="item"> Kolkata</li>
                                 <li className="item"> Delhi</li>
                            </ul>
                            <h5 className="text-warning">LAZEEZ AFFAIRE</h5>
                            <ul>
                                 <li className="item"> Delhi</li>
                            </ul>
                        </div>
            ...
            <section className="bg-black text-white pt-5">
                ...
                <div className="container">
                    <div className="row">
                        <div className="col-md-2">
                        <h5 className="pt-5 text-warning">DIABLO</h5>
                            <ul>
                                <li className="item">Jaipur</li>
                                 <li className="item"> Delhi</li>
                                 <li className="item">Indore</li>
                            ...
                            <h5 className="pt-5 text-warning">FLYING SAUCER</h5>
                            <ul>
                                 <li className="item">Bhopal</li>
                                 <li className="item">Jhansi</li>
                            </ul>
                        ...
                        <div className="col-md-2">
                        <h5 className="pt-5 text-warning">LOTD</h5>
                            <ul>
                                 <li className="item"> Noida</li>
                                 <li className="item"> Delhi</li>
                                 <li className="item"> Hyderabad</li>
                                ...
                                <h5 className="pt-5 text-warning">LAZEEZ AFFAIRE</h5>
                            <ul>
                                 <li className="item"> Delhi</li>
                                 <li className="item"> Delhi</li>
                                 <li className="item"> Hyderabad</li>
                        ...
                        <div className="col-md-2">
                        <h5 className="pt-5 text-warning">WAREHOUSE</h5>
                            <ul>
                                 <li className="item"> Kolkata</li>
                                 <li className="item"> Delhi</li>
                            </ul>
                        <h5 className="pt-5 text-warning">TICKLED PINK</h5>
                            <ul>
                                 <li className="item">Delhi</li>
                                 <li className="item"> Lucknow</li>
                            </ul>
                ...
                <div className="container">
                    <div className="row">
                        <div className="col-md-4">
                            <img src="https://www.firstfiddle.in/_next/image?url=%2Fimages%2Fabout%2F2.jpg&w=640&q=75" alt="" className="img-fluid pt-3"></img>
                        </div>
                        <div className="col-md-4">
                        ...
                        <div className="col-md-4">
                            <img src="https://www.firstfiddle.in/_next/image?url=%2Fimages%2Fabout%2F4.jpg&w=640&q=75" alt="" className="img-fluid pt-3"></img>
                        </div>
                        <div className="col-md-4">
                            <img src="https://www.firstfiddle.in/_next/image?url=%2Fimages%2Fabout%2F3.jpg&w=640&q=75" alt="" className="img-fluid pt-3"></img>
                        </div>
                        <div className="col-md-4">
                            <img src="https://www.firstfiddle.in/_next/image?url=%2Fimages%2Fabout%2F6.jpg&w=640&q=75" alt="" className="img-fluid pt-3"></img>
                        </div>
                    </div>
                </div>
            </section>
